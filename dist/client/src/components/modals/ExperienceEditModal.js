...
const getInitialvalues = (experience) => ({
    file: null,
    id: experience.id,
...
const ExperienceEditModal = ({ updateRecord, experience, handleClose, }) => {
    const handleModalClose = (resetForm) => {
        resetForm();
        handleClose();
    };
    return (<react_bootstrap_1.Modal show={true} centered>
      <formik_1.Formik initialValues={getInitialvalues(experience)} enableReinitialize validationSchema={validationSchema_1.validateSchema} onSubmit={utils_1.noop}>
        {({ setFieldValue, dirty, values, resetForm, errors }) => (<>
            ...
            <react_bootstrap_1.Modal.Body>
              <form>
                ...
                <react_bootstrap_1.Form.Control type="text" name="description" as="textarea" rows={5} data-testid="add-modal-description" value={values.description} onChange={(e) => setFieldValue("description", e.target.value)}/>
                <react_bootstrap_1.Form.Label className="mt-3" htmlFor="inputPassword5">
                  Job Title
                </react_bootstrap_1.Form.Label>
            ...
            <react_bootstrap_1.Modal.Footer>
              ...
              <react_bootstrap_1.Button variant="primary" disabled={!dirty || Object.keys(errors).length > 0} onClick={() => (0, utils_1.onSubmit)(values, updateRecord, handleClose)}>
                Update
              </react_bootstrap_1.Button>
            </react_bootstrap_1.Modal.Footer>
          </>)}
...
exports.default = ExperienceEditModal;
