...
const addFile = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    if (req.file) {
        const storageRef = (0, storage_1.ref)(firebase_1.storage, `files/${req.file.originalname}`);
        const uploadTask = (0, storage_1.uploadBytesResumable)(storageRef, req.file.buffer);
